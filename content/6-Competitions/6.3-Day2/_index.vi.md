...
### 5. Cấu trúc Báo cáo Sự cố Chuẩn mực (The 5-Block Incident Report)

Báo cáo sự cố của đội thi được định dạng theo 5 khối tiêu chuẩn nghiêm ngặt (định dạng PDF, Doc hoặc Markdown):

| Khối nội dung | Yêu cầu chuẩn mực bắt buộc |
| :--- | :--- |
| **01 · Câu hỏi sự cố & Phạm vi (Question & Scope)** | Mô tả chính xác: Điều gì bị hỏng, ảnh hưởng đến đối tượng người dùng nào, và bắt đầu từ mốc thời gian nào. |
| **02 · Tối thiểu 2 giả thuyết, 1 bị loại trừ** | Nêu rõ bằng chứng hỗ trợ cho từng giả thuyết, và **câu truy vấn cụ thể đã loại trừ giả thuyết thất bại**. |
| **03 · Tập bằng chứng then chốt (Key Evidence)** | Bộ ba trường chuẩn mực: **Nguồn (Source) — Phạm vi (Scope) — Thời điểm (Time)** kèm nhãn trạng thái `[verified]` hoặc `[blocked]`. |
| **04 · Cơ chế chuỗi nguyên nhân (Causal Mechanism)** | Sơ đồ liên kết nhân quả từ trigger đến customer impact, nêu rõ mắt xích nào chưa thể chứng minh (*unproven edge*). |
| **05 · Tách bạch Nguyên nhân gốc & Yếu tố đóng góp** | Chỉ rõ tài nguyên nào có cấu hình bị thay đổi kèm **mốc thời gian xác thực (dated)**, phân biệt rõ với các điều kiện nền tảng không có mốc thời gian (*undated*). |
